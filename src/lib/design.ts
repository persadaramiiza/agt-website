...
export const industries = [
  {
    ...
    description:
      "Advanced coagulants and flocculants for municipal and industrial wastewater purification.",
    tags: ["Coagulants", "Flocculants"],
    featured: true,
  },
  {
    name: "Food & Beverage",
  ...
  },
  {
    name: "Mining",
    description:
      "Specialized reagents to improve mineral recovery rates and operational efficiency.",
  },
  {
    name: "Agriculture",
    description:
      "Soil conditioning polymers and nutrient stabilizers for enhanced crop yields.",
  },
];
